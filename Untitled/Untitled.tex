...
\begin{frontmatter}
  ...
  \title{Short Paper}
    \author[Laboratório de Ictiologia - Universidade Federal do Rio
Grande FURG]{Amanda Letícia Bauer%
  \corref{cor1}%
  \fnref{1}}
   \ead{amandaleticiabauer@hotmail.com} 
    \author[Laboratório de Ecologia de Peixes - Universidade do Vale do
Rio dos Sinos UNISINOS]{Gabriela Buzlarf%
  %
  }
   \ead{bob@example.com} 
    \author[Another University]{Kelly Correia de Lima%
  %
  \fnref{2}}
   \ead{cat@example.com} 
    \author[Laboratório de Ecologia de Peixes - Universidade do Vale do
Rio dos Sinos UNISINOS]{Derek Zoolander%
  %
  \fnref{2}}
...
library(tinytex) Please make sure that your manuscript follows the
guidelines in the Guide for Authors of the relevant journal. It is not
necessary to typeset your manuscript in exactly the same way as an
article, unless you are submitting to a camera-ready copy (CRC) journal.
